...
namespace arm_template_event_subscription
{
    class Program
    {
        ...
        const string StorageAccountId = "replace-with-your-storage-account-resource-id";
        const string QueueName = "replace-with-your-queue-name-under-the-above-storage-account";
        ...
        static async Task PerformEventSubscriptionOperationsForStorageEvents()
        {
            ...
            try
            {
                ...
                await CreateEventGridEventSubscriptionAsync(SubscriptionId, EventSubscriptionName, eventGridManagementClient);

                // Delete the event subscription
                await DeleteEventGridEventSubscriptionAsync(SubscriptionId, EventSubscriptionName, eventGridManagementClient);
        ...
        static async Task RegisterEventGridResourceProviderAsync(ResourceManagementClient resourcesClient)
        {
        ...
        static async Task DeleteEventGridEventSubscriptionAsync(string azureSubscriptionId, string eventSubscriptionName, EventGridManagementClient eventGridMgmtClient)
        {
            string scope = $"/subscriptions/{azureSubscriptionId}";
            Console.WriteLine($"Deleting event subscription {eventSubscriptionName}...");

            await eventGridMgmtClient.EventSubscriptions.DeleteAsync(scope, eventSubscriptionName);
